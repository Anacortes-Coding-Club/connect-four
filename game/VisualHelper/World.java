...
public class World extends JFrame {
	...
	private CopyOnWriteArrayList<KeyEvent> keysPressed = new CopyOnWriteArrayList<KeyEvent>();
	...
	public World(int width, int height, Color backgroundColor) {
		...
		@Override public void keyPressed(KeyEvent arg0) { if(!getKeyPressed(arg0.getKeyCode())) { keysPressed.add(arg0); } }
		@Override public void keyReleased(KeyEvent arg0) {  if(getKeyPressed(arg0.getKeyCode())) { removeKey(arg0.getKeyCode()); } }
	...
	void drawLine(Point2D p1, Point2D p2, double width, Color color) {
		...
		this.gg.setStroke(new BasicStroke((float)width, BasicStroke.CAP_BUTT, BasicStroke.CAP_BUTT));
		Line2D.Double line = new Line2D.Double(p1, p2);
		this.gg.draw(line);

		// show the drawn lines
		//this.blit(); // edit edit edit edit edit edit edit edit edit edit edit edit edit edit edit edit edit edit edit
	}
